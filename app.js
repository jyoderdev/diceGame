...
1. A player loses his ENTIRE score when he rolls two 6's in a row. After 
that, it's the next player's turn. (Hint: Always save the previous dice 
...
need CSS to position the second dice, so take a look at the CSS code for 
the first one.)
*/
